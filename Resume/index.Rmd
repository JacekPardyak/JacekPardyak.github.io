...
Then install the development version of the package from GitHub using this command:
...
knitr::include_graphics("./figures/Capture1.PNG")
```
...
```{r, echo=FALSE, out.width = "750px", fig.align="center"}
knitr::include_graphics("./figures/Capture2.PNG")
```


Finally use the **Knit** button to produce resulting **document**^[[Example of the resulting document](./figures/Untitled.pdf)]:

```{r, echo=FALSE, out.width = "750px", fig.align="center"}
knitr::include_graphics("./figures/Capture3.PNG")
```
