...
\textbf{Hij is van mij} \citep{Hij-is-van-mij} \href{https://youtu.be/EYhLEHE1vfQ}{\includegraphics{./images/_Youtube}} \emph{On jest mój} to luźny cover `The Boy Is Mine' amerykańskiego duetu Brenda i Monica. W 2019 roku był najlepiej sprzedającym się singlem w Holandii.
...
\textbf{Links en rechts} \citep{Links-en-rechts} \href{https://youtu.be/miac8oRrEcI}{\includegraphics{./images/_Youtube}} \emph{W lewo i w prawo} NOTE.
...
\textbf{Suzanne} \citep{Suzanne} \href{https://youtu.be/jgiPEsgkhKk}{\includegraphics{./images/_Youtube}} \emph{Suzanne} to piosenka z największą liczbą coverów wykonanych w innych językach. Michał Wiśniewski napisał polskie słowa do jego piosenki Zuzanna, dość odległe od oryginału.
...
\textbf{'t Smidje} \citep{T-smidje} \href{https://youtu.be/mJ6vmtFBlWY}{\includegraphics{./images/_Youtube}} \emph{Młody kowal} to stara flamandzka piosenka, która stała się popularna w 1998 roku w Hiszpanii i Polsce dzięki grupie Laïs. Stara pisownia z 1848 roku.
...
\textbf{Afscheid nemen bestaat niet} \citep{Afscheid-nemen-bestaat-niet} \href{https://youtu.be/lSo6LyEA1ks}{\includegraphics{./images/_Youtube}} \emph{Żegnamy się, nie istnieje} to najpopularniejsza niderlandzkojęzyczna piosenka na pogrzebach.
...
\textbf{Avond} \citep{Avond} \href{https://youtu.be/ptGJ8wzeGDE}{\includegraphics{./images/_Youtube}} \emph{Wieczór} to piosenka uznawana przez Holendrów za najlepszą niderlandzkojęzyczną piosenkę wszechczasóW.
...
\textbf{Blauwe Dag} \citep{Blauwe-dag} \href{https://youtu.be/keYF1D0LVQk}{\includegraphics{./images/_Youtube}} \emph{Gorszy Dzień} \ldots\ldots.. .
...
\textbf{Brabant} \citep{Brabant} \href{https://youtu.be/YaIzl1Tz-so}{\includegraphics{./images/_Youtube}} \emph{Brabancja} to nieoficjalny hymn Brabancji Północnej, który powstał w Moskwie.
...
\textbf{Dromen zijn bedrog} \citep{Dromen-zijn-bedrog} \href{https://youtu.be/CuA2U9iU6lQ}{\includegraphics{./images/_Youtube}} \emph{Sny są ulotne} jest uważana za jeden z najbardziej udanych singli w języku niderlandzkim wszech czasów.
...
\textbf{Duurt Te Lang} \citep{Duurt-te-lang} \href{https://youtu.be/n_j1clPqEvg}{\includegraphics{./images/_Youtube}} \emph{To trwa zbyt długo} to numer, który czekał 5 lat na nowego wykonawcę i stanie się hitem.
...
\textbf{Een beetje verliefd} \citep{Een-beetje-verliefd} \href{https://youtu.be/3kufNNxyACg}{\includegraphics{./images/_Youtube}} \emph{Trochę zakochany} to piosenka o niespełnionej miłości Rozpoczyna się w scenerii podobnej do tej z piosenki \ref{Leef} wykonanej przez syna André Hazes jr.
...
\textbf{Het dorp} \citep{Het-dorp} \href{https://youtu.be/C8Ff5OEUzd8}{\includegraphics{./images/_Youtube}} \emph{Wieś} to wspomnienia autora tekstu o utraconym dzieciństwie. Hugo Verhage to naprawdę Friso Wiegersma. Z wykonawcą piosenki Wimem Sonneveld byli w związku. .
...
\textbf{Het is een nacht} \citep{Het-is-een-nacht} \href{https://youtu.be/BMqZIFVYUXw}{\includegraphics{./images/_Youtube}} \emph{Jest taka noc} powstała po romantycznym weekendzie, jaki spędził autor ze swoją dziewczyną Valérie Gregoire w Brugii.
...
\textbf{Ik kan het niet alleen} \citep{Ik-kan-het-niet-alleen} \href{https://youtu.be/ltSsojzp90M}{\includegraphics{./images/_Youtube}} \emph{Ja tak nie mogę sam} to jedna z najbardziej znanych piosenek De Dijk do dziś odtwarzana przez wiele stacji radiowych w Holandii..
...
\textbf{Ik Voel Me Zo Verdomd Alleen} \citep{Ik-voel-me-zo-verdomd-alleen} \href{https://youtu.be/G-JcK8MbWFw}{\includegraphics{./images/_Youtube}} \emph{Czuję się tak cholernie samotny} pochodzi z filmu `Ciske de Rat' opartego na książkach Piet Bakkera. Danny De Munk zagrał w nim i wykonał tytułową piosenką.
...
\textbf{La vie est belle} \citep{La-vie-est-belle} \href{https://youtu.be/DLTq19bhO28}{\includegraphics{./images/_Youtube}} \emph{Życie jest piękne} \ldots{} . Koen Jansen (Diggy Dex) napisał również tekst do piosenki \ref{Leef}.
...
\textbf{Leef} \citep{Leef} \href{https://youtu.be/2H0yWKdZM8g}{\includegraphics{./images/_Youtube}} \emph{Żyj} to piosenka o życiu i umieraniu. Rozpoczyna się w scenerii podobnej do tej z piosenki \ref{Een-beetje-verliefd} wykonanej przez ojca André Hazes.
...
\textbf{Liefs uit Londen} \citep{Liefs-uit-Londen} \href{https://youtu.be/aM5JU0juOSs}{\includegraphics{./images/_Youtube}} \emph{Kocham z Londynu} to pierwszy z hitów grupy BLØF, którego tekst był zainspirowany grą planszową `Podróż dookoła świata'.
...
\textbf{Mag ik dan bij jou} \citep{Mag-ik-dan-bij-jou} \href{https://youtu.be/o5uvsEs79hM}{\includegraphics{./images/_Youtube}} \emph{Czy będę mogła przy tobie?} to wyznanie miłosne wypełnione przypuszczeniami.
...
\textbf{Nacht} \citep{Nacht} \href{https://youtu.be/MxkdVogPeF0}{\includegraphics{./images/_Youtube}} \emph{Noc} to nowa wersja 25-letniego utworu ``Het is een nacht'' \ref{Het-is-een-nacht}.
...
\textbf{Oceaan} \citep{Oceaan} \href{https://youtu.be/-OKB7wd7ems}{\includegraphics{./images/_Youtube}} \emph{Ocean} to ich pierwsza piosenka w języku niderlandzkim.
...
\textbf{O, o, Den Haag} \citep{O-o-Den-Haag} \href{https://youtu.be/ptGJ8wzeGDE}{\includegraphics{./images/_Youtube}} \emph{Oj, oj, Haga} to piosenka uznawana za nieoficjalny hymn Hagi. Nazwa wykonawcy to anagram nazwy prawdziwego zespołu Klein Orkest.
...
\textbf{Over de muur} \citep{Over-de-muur} \href{https://youtu.be/rAR6XKHfXY0}{\includegraphics{./images/_Youtube}} \emph{Ponad murem} to holenderski poprzednik polskiej ``Arahji'' Kultu. ``Mój dom murem podzielony'' to jakby nie było ``Mijn huis door een muur gescheiden''.
...
\textbf{Papa} \citep{Papa} \href{https://youtu.be/ptGJ8wzeGDE}{\includegraphics{./images/_Youtube}} \emph{Tato} to wyznanie skierowane do ojca Bosa u którego zdiagnozowano raka. Leczenie ``Taty'' się powiodło, zmarł przeżywszy jeszcze 23 lata.
...
\textbf{Pastorale} \citep{Pastorale} \href{https://youtu.be/x5cntzEZo1w}{\includegraphics{./images/_Youtube}} \emph{Pastorałka} to psychodeliczna rozmowa ziemskiego dziecka z potężnym słońcem .
...
\textbf{Per spoor (Kedeng kedeng)} \citep{Per-spoor} \href{https://youtu.be/lSxh-UK7Ays}{\includegraphics{./images/_Youtube}} \emph{Koleją (Bang bang)} to zapis z podróży pociągiem do dziewczyny..
...
\textbf{Zing, Vecht, Huil, Bid, Lach, Werk en Bewonder} \citep{Zing-vecht-huil-bid-lach-werk-en-bewonder} \href{https://youtu.be/xg07TjHOlUM}{\includegraphics{./images/_Youtube}} \emph{Śpiewaj, Walcz, Płacz, Módl Się, Śmiej Się, Pracuj i Podziwiaj} NOTE.
...
\textbf{België (Is er leven op Pluto\ldots?)} \citep{Belgie} \href{https://youtu.be/jwucIydijEo}{\includegraphics{./images/_Youtube}} \emph{Belgia (Czy na Plutonie jest życie \ldots?)} to chyba jedyna piosenka, w której pojawia się Polska.
...
\textbf{Alles kan een mens gelukkig maken} \citep{Alles-kan-een-mens-gelukkig-maken} \href{https://youtu.be/EstXeHNJD7c}{\includegraphics{./images/_Youtube}} \emph{Wszystko może uszczęśliwić człowieka} to utwór znany również pod tytułem `Een eigen huis'.
...
\textbf{Het regent zonnestralen} \citep{Het-regent-zonnestralen} \href{https://youtu.be/dZkbhA1NcTM}{\includegraphics{./images/_Youtube}} \emph{Pada promieniami słonecznymi} NOTE.
...
\textbf{Zoutelande} \citep{Zoutelande} \href{https://youtu.be/N0OLEgc-Glk}{\includegraphics{./images/_Youtube}} \emph{Zoutelande} to niderlandzkojęzyczny cover piosenki `Frankfurt Oder' niemieckiej pary Axel Bosse \& Anna Loos.
...
\textbf{Dat komt door jou} \citep{Dat-komt-door-jou} \href{https://youtu.be/fl3epWazJxs}{\includegraphics{./images/_Youtube}} \emph{Dat komt door jou} NOTE.
...
\textbf{Dochters} \citep{Dochters} \href{https://youtu.be/7azASBMAkOU}{\includegraphics{./images/_Youtube}} \emph{Córki} mają tekst niezwykle podobny do Butterfly Kisses Boba Carlisle'a z 1997 roku.
...
\textbf{Testament} \citep{Testament} \href{https://youtu.be/26bMxDiMFQc}{\includegraphics{./images/_Youtube}} \emph{Testament} NOTE.
...
\textbf{15 Miljoen Mensen} \citep{Vijftien-miljoen-mensen} \href{https://youtu.be/iOxYmMNOE-o}{\includegraphics{./images/_Youtube}} \emph{15 Milionów Ludzi} NOTE.
...
\textbf{Het land van\ldots{}} \citep{Het-land-van} \href{https://youtu.be/yayMuZxlttc}{\includegraphics{./images/_Youtube}} \emph{Kraj pochodzenia} to gniewna litania z wadami i zaletami życia w Holandii. Osobiście zabrakło mi tylko sera, małżeństw jednopłciowych, wiatraków i \ldots{} Polaków.
