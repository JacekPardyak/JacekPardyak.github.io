...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{Sys.setlocale}\NormalTok{(}\StringTok{"LC\_ALL"}\NormalTok{,}\StringTok{"Polish"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.8\linewidth]{liedboek_files/figure-latex/nice-fig-1} 
...
\hypertarget{lief-ux17cyj}{%
\section{Lief (Żyj)}\label{lief-ux17cyj}}

Melodia pierwszej edycji holenderskiego Big Brothera i wielki hit z 1999 roku. Posłuchajcie sami.

\hypertarget{tekst}{%
\subsection{Tekst}\label{tekst}}
...
\hspace*{0.333em}\\
\textgreater{} Leef, met je eigen talent\\
\textgreater{} Iedereen is mooi, als bent wie je bent\\
\textgreater{} Leef, met jezelf en elkaar\\
\textgreater{} Iedereen is blij met dat ene gebaar\\
\hspace*{0.333em}\\
...
En we kunnen niet perfect zijn want niemand weet hoe dat moet\\
\hspace*{0.333em}\\
\textgreater{} Żyj z własnym talentem\\
\textgreater{} Iedereen is mooi, als bent wie je bent\\
\textgreater{} Leef, met jezelf en elkaar\\
\textgreater{} Iedereen is blij met dat ene gebaar\\
\hspace*{0.333em}\\
...
\hypertarget{pomoc-jux119zykowa}{%
\subsection{Pomoc językowa}\label{pomoc-jux119zykowa}}
...
\hypertarget{two-columns---template}{%
\chapter{Two columns - template}\label{two-columns---template}}
...
\includegraphics{liedboek_files/figure-latex/unnamed-chunk-8-1.pdf}
