...
Załóżmy, że tam byłem\\
A ty nie\\
Wtedy rano\\
Rano pewnie był kolejny taki dzień
...
\section{\texorpdfstring{Liefs uit Londen, \emph{BLOF}}{Liefs uit Londen, BLOF}}\label{Liefs-uit-Londen}}
...
\textbf{Liefs uit Londen} \citep{Liefs-uit-Londen} {[}\emph{Kocham z Londynu}{]} to pierwszy z hitów grupy BLOF, którego tekst był zainspirowany grą planszową `'Podróż dookoła świata''.
