...
\textbf{'t Smidje} \citep{T-smidje} \href{https://youtu.be/mJ6vmtFBlWY}{\includegraphics{./images/youtube/_Youtube}} \emph{Młody kowal} to stara flamandzka piosenka, która stała się popularna w 1998 roku w Hiszpanii i Polsce dzięki grupie Laïs. Pisownia z 1848 roku.
...
\hypertarget{De-weg}{%
\section{\texorpdfstring{De weg, \emph{Guus Meeuwis}}{De weg, Guus Meeuwis}}\label{De-weg}}

\begin{column}{0.10\textwidth}

\includegraphics{./images/De-weg}
...
\textbf{De weg} \citep{De-weg} \href{https://youtu.be/vuGcIfMq65A}{\includegraphics{./images/youtube/_Youtube}} \emph{Droga} to luźny cover piosenki `Der weg' niemieckiego piosenkarza Herberta Grönemeyera.
...
\emph{Waar jij verscheen scheen de zon met je mee}\\
\emph{Geen tijd voor verdriet maar elke dag omarmd}\\
\emph{En altijd vrolijk hoe jij dat voor elkaar kreeg}\\
\emph{Met oneindig veel moed het leven is niet fair}
...
\emph{Tam, gdzie się pojawiałaś, świeciło słońce wraz z tobą}\\
\emph{Nie ma czasu na smutek, jednak obejmuje każdego dnia}\\
\emph{I zawsze szczęśliwa, jak ci się to udawało}\\
\emph{Z nieskończenie wielkim zapałem, życie jest nie fair}
...
\tightlist
\item
  \textbf{Wat mijn collega zegt, is simpelweg gelogen.} To, co mówi mój kolega jest po prostu kłamstwem.\\
\item
  \textbf{Sommige oppositieleiders riskeren zelfs de doodstraf.} Niektórzy przywódcy opozycji ryzykują nawet karą śmierci.\\
\item
  \textbf{Tomek is degene die alles voor elkaar kreeg.} Tomek jest taki, że wszystko załatwi.\\
\item
  \textbf{Hou moed!} Odwagi!\\
\item
  \textbf{Adam had vast niet gewild dat je hem beweent.} Adam na pewno nie chciałby żebyś za nim płakała.\\
\item
  \textbf{Ik loop doelloos door de stad.} Idę bez celu przez miasto.\\
\item
  \textbf{Je bent dronken.} Jesteś pijany.\\
\item
  \textbf{Een groot deel van het skelet is in de modder verzonken.} Duża część szkieletu jest zatopiona w błocie.
\end{itemize}
...
\hypertarget{Zeg-me-dat-het-niet-zo-is}{%
\section{\texorpdfstring{Zeg me dat het niet zo is, \emph{Frank Boeijen Groep}}{Zeg me dat het niet zo is, Frank Boeijen Groep}}\label{Zeg-me-dat-het-niet-zo-is}}

\begin{column}{0.10\textwidth}

\includegraphics{./images/Zeg-me-dat-het-niet-zo-is}
...
\textbf{Zeg me dat het niet zo is} \citep{Zeg-me-dat-het-niet-zo-is} \href{https://youtu.be/BKiwbpRvh84}{\includegraphics{./images/youtube/_Youtube}} \emph{Powiedz, że to nie jest tak} stała się popularna jedynie dzięki innym wykonawcom.
...
\emph{Zeg me dat het niet zo is}\\
\emph{Zeg me dat het niet zo is}\\
\emph{Zeg me dat het niet waar is}
...
\emph{Powiedz, że to nie jest tak}\\
\emph{Powiedz, że to nie jest tak}\\
\emph{Powiedz, że to nie jest prawda}
...
En we drinken totdat de zon op komt\\
...
Chodź ze mną dziś wieczorem do naszej ulubionej restauracji\\
Zamówiłem stolik dla dwojga, już wiedzą o tym\\
I będziemy pić, aż do wschodu słońca\\
I zapomnimy o nieuczciwości losu
...
Chodź idziemy, załóż płaszcz, inaczej będzie za późno\\
Podejdź, przytulę cię, nie pozwolę ci nigdy więcej wyjść\\
I opowiem ci dowcip taki, że zapłaczesz ze śmiechu\\
I zapomnimy o spojrzeniach ludzi na mieście
...
Alsof het niet zo is, alsof het niet waar is\\
We doen net alsof ze gewoon verder leeft\\
Alsof ze gewoon verder leeft, zelfs als het niet zo is
...
Udajemy, jakby to nie było tak\\
Jakby to nie było tak, jakby to nie była prawda\\
Udajemy, jakby po prostu żyła dalej\\
Jakby po prostu żyła, nawet jeśli to nie jest tak
...
\tightlist
\item
  \textbf{Ik kan allerlei verraad en oneerlijkheid vergeven.} Mogę wybaczyć wszelkiego rodzaju zdradę i nieuczciwość.\\
\item
  \textbf{Laten we doen alsof we buitenaardse wezens zijn.} Udawajmy, że jesteśmy kosmitami.
\end{itemize}
